    ...
    <div class="panel-body">
        ...
        <form action="" method="POST" id="registrousuario">
            ...
            <div class="form-group">
                ...
                <input id="contra" type="text" name="password" class="form-control" value="{{ old('password', str_random(8)) }}" required>
            </div>
            <div class="form-group">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="{{ url ('/usuario',[$user->id,'eliminar'])}}" class="btn btn-sm btn-danger" title="Dar de baja">
